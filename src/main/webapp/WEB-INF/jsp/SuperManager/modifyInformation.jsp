...
<body>
		...
		<form action="super_modifyInformation" class="col-lg-8 col-lg-offset-3 col-md-9 col-md-offset-3 col-xs-9 col-xs-offset-2" style="margin-top:60px;">
			<input type="hidden" value="${role.sup_accountNum}" id="num" name="sup_accountNum">
			<div class="row">
	        	<div class="col-lg-3 col-lg-offset-2 col-md-3 col-md-offset-3 col-xs-3 col-xs-offset-2"><p>原始密码：</p></div>
			...
			<div class="row">
	        	<div class="col-lg-3 col-lg-offset-2 col-md-3 col-md-offset-3 col-xs-3 col-xs-offset-2"><p>新密码：</p></div>
	     	...
	     	<div class="row">
	        	<div class="col-lg-3 col-lg-offset-2 col-md-2 col-md-offset-3 col-xs-3 col-xs-offset-2"><p>再次输入密码：</p></div>
