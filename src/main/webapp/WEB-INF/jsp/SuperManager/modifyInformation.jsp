...
<body>
		...
		<form action="super_modifyInformation">
			...
			<div class="row">
	            ...
	            <div class="col-lg-2 col-md-2 col-xs-3 "><input type="password" class=" form-control "  id="oldpassword" onchange="jugeOldPassword('super_jugePassword',1);"> </div>
	     	</div>
			...
			<div class="row">
	     	...
	     	<div class="row">
	            ...
	            <div class="col-lg-2 col-md-2 col-xs-3"><input type="password"  class="form-control" name="sup_password" id="secondpassword" onchange="compareInput();"> </div>
	     	</div>
	     	<br>
